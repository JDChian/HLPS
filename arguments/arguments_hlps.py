...
def get_args_ant():
    ...
    parser.add_argument('--n-epochs', type=int, default=5000, help='the number of epochs to train the agent')
    ...
    parser.add_argument('--wandb', type=bool, default=True, help='wandb or not')
    ...
    parser.add_argument('--philr', type=float, default=1e-4, help='Phi learning rate')

    parser.add_argument('--gamma2', type=float, default=1.0, help='initial gamma2')
    parser.add_argument('--ell', type=float, default=0.001, help='initial ell')
    parser.add_argument('--sigma2', type=float, default=-3.0, help='initial sigma2')
    parser.add_argument('--gamma2l', type=float, default=-1, help='lower bound of gamma2')
    parser.add_argument('--gamma2h', type=float, default=1, help='higher bound of gamma2')
    parser.add_argument('--elll', type=float, default=-1, help='lower bound of ell')
    parser.add_argument('--ellh', type=float, default=1, help='higher bound of ell')
    parser.add_argument('--sigma2l', type=float, default=-3.0, help='lower bound of sigma2')
    parser.add_argument('--sigma2h', type=float, default=-1.0, help='higher bound of sigma2')
    parser.add_argument('--gplr', type=float, default=1e-5, help='GP learning rate')
    parser.add_argument('--gp_update_interval', type=float, default=100, help='GP update interval')
    parser.add_argument('--start_update_gp', type=float, default=10, help='GP update interval')
    parser.add_argument('--time_window', type=float, default=3, help='GP time window')
